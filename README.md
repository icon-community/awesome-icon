...
- [icon-community/crosschain-voting-dapp](https://github.com/icon-community/crosschain-voting-dapp/tree/master) - xCall dapp example of a crosschain voting scenario.
